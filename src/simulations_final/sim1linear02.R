# Simulation script for the first model variable and prob = 0.2 (with exposure mappings), passing parameters as a config file
...
output_file <- paste0("sim1linear02", network, network_size, ".csv")

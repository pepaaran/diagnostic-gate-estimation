# Simulation script for the first model variable and prob = 0.2 (with exposure mappings) and dynamic response
...
output_file <- paste0("sim1dynamic02", network, network_size,".csv")
